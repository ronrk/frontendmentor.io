...
planets in the Solar System, and is a rocky body like Earth.`,
      internal: `Mercury appears to have a solid silicate crust and mantle overlying a 
      ...
      surface: `Mercury's surface is similar in appearance to that of the Moon, showing 
    ...
    srcUrl: "https://en.wikipedia.org/wiki/Mercury_(planet)",
    rotation: 58.6,
    revolution: 87.97,
    radius: 2439.7,
    avgTemp: "430°c",
  },
  {
    ...
    content: {
      ...
      internal: `The similarity in size and density between Venus and Earth suggests 
    ...
    srcUrl: "https://en.wikipedia.org/wiki/Venus",
    rotation: 243,
    revolution: 224.7,
    radius: 6051.8,
    avgTemp: "471°c",
  },
  {
    ...
    content: {
      ...
      internal: `Earth's interior, like that of the other terrestrial planets, is divided 
      ...
      surface: `The total surface area of Earth is about 510 million km2. The continental 
    ...
    srcUrl: "https://en.wikipedia.org/wiki/Earth",
    rotation: 0.99,
    revolution: 365.26,
    radius: 6371,
    avgTemp: "16°c",
  },
  {
    ...
    content: {
      ...
      the "Red Planet".`,
      internal: `Like Earth, Mars has differentiated into a dense metallic core overlaid 
      ...
      surface: `Mars is a terrestrial planet whose surface consists of minerals containing 
    ...
    srcUrl: "https://en.wikipedia.org/wiki/Mars",
    rotation: 1.03,
    revolution: 1.88,
    radius: 3389.5,
    avgTemp: "-28°c",
  },
  {
    ...
    content: {
      ...
      of the Sun.`,
      internal: `When the Juno arrived in 2016, it found that Jupiter has a very diffuse core 
      ...
      surface: `The best known feature of Jupiter is the Great Red Spot, a persistent 
    ...
    srcUrl: "https://en.wikipedia.org/wiki/Jupiter",
    rotation: 9.93,
    revolution: 11.86,
    radius: 69911,
    avgTemp: "-108°c",
  },
  {
    ...
    content: {
      ...
      density of Earth.`,
      internal: `Despite consisting mostly of hydrogen and helium, most of Saturn's mass 
      ...
      surface: `The outer atmosphere of Saturn contains 96.3% molecular hydrogen and 3.25% 
    ...
    srcUrl: "https://en.wikipedia.org/wiki/Saturn",
    rotation: 10.8,
    revolution: 29.46,
    radius: 58232,
    avgTemp: "-138°c",
  },
  {
    ...
    content: {
      ...
      internal: `The standard model of Uranus's structure is that it consists of three layers: a 
      ...
      surface: `The composition of Uranus's atmosphere is different from its bulk, consisting mainly 
    ...
    srcUrl: "https://en.wikipedia.org/wiki/Uranus",
    rotation: 17.2,
    revolution: 84,
    radius: 25362,
    avgTemp: "-195°c",
  },
  {
    ...
    content: {
      ...
      internal: `Neptune's internal structure resembles that of Uranus. Its atmosphere forms about 5% 
    ...
    srcUrl: "https://en.wikipedia.org/wiki/Neptune",
    rotation: 16.08,
    revolution: 164.79,
    radius: 24622,
    avgTemp: "-201°c",
