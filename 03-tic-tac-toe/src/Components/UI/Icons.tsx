export const IconOOutlined = ({ ...rest }) => {
  return (
    <svg width="66" height="66" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path
...
export const IconXOutlined = ({ ...rest }) => {
  return (
    <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path
...
export const Logo = ({ ...rest }) => {
  return (
    <svg width="72" height="32" xmlns="http://www.w3.org/2000/svg" {...rest}>
...
export const IconRestart = ({ ...rest }) => {
  return (
    <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path
